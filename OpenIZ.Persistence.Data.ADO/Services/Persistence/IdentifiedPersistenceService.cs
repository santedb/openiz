...
namespace OpenIZ.Persistence.Data.ADO.Services.Persistence
{
        ...
        where TDomain : class, IDbIdentified, new()
    {
        ...
        {
            return this.DoQueryInternal(context, query, queryId, offset, count, out totalResults, countResults).Select(o => o is Guid ? this.Get(context, (Guid)o, principal) : this.CacheConvert(o, context, principal));
        }
